...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('frontend/assets/css/media.css') ?>">
  <link rel="icon" href="<?php echo base_url('frontend/assets/images/logo.png') ?>">
</head>